...
const Menu = () => {
  ...
  const goToSlide = (index: number) => setCurrentIndex((index + allCocktails.length) % allCocktails.length);
  const getCocktailAt = (indexOffset: number) => allCocktails[(currentIndex + indexOffset + allCocktails.length) % allCocktails.length];
